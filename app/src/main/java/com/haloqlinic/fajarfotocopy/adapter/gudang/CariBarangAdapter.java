...
public class CariBarangAdapter extends RecyclerView.Adapter<CariBarangAdapter.CariBarangViewHolder> {

    Context context;
    List<SearchBarangByNamaItem> dataBarang;

    public CariBarangAdapter(Context context, List<SearchBarangByNamaItem> dataBarang) {
    ...
    @NotNull
    @Override
    public CariBarangViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_data_barang, parent, false);
        return new CariBarangViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull CariBarangViewHolder holder, int position) {
    ...
    public class CariBarangViewHolder extends RecyclerView.ViewHolder {
