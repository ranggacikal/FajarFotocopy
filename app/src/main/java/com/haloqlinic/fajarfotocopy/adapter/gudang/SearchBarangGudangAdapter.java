...
public class SearchBarangGudangAdapter extends RecyclerView.Adapter<SearchBarangGudangAdapter.SearchBarangGudangViewHolder>{

    Context context;
    List<SearchBarangGudangItem> dataBarang;

    public SearchBarangGudangAdapter(Context context, List<SearchBarangGudangItem> dataBarang) {
    ...
    @NonNull
    @Override
    public SearchBarangGudangViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_data_barang, parent, false);
        return new SearchBarangGudangAdapter.SearchBarangGudangViewHolder(view);    }

    @Override
    public void onBindViewHolder(@NonNull SearchBarangGudangViewHolder holder, int position) {
    ...
    public class SearchBarangGudangViewHolder extends RecyclerView.ViewHolder {
        TextView txtNamaBarang, txtModalGudangPcs, txtModalGudangPack, txtStockPcs, txtStockPack;
        ImageView imgBarang;

        public SearchBarangGudangViewHolder(@NonNull View itemView) {
            super(itemView);
