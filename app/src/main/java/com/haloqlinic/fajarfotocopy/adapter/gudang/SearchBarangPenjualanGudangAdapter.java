...
public class SearchBarangPenjualanGudangAdapter extends RecyclerView.Adapter<SearchBarangPenjualanGudangAdapter.SearchBarangPenjualanGudangViewHolder>{
    ...
    public SearchBarangPenjualanGudangAdapter(Context context, List<SearchBarangGudangItem> dataBarang, SupplierGudangActivity supplierGudangActivity) {
    ...
    @NonNull
    @Override
    public SearchBarangPenjualanGudangViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_barang_outlet, parent, false);
        return new SearchBarangPenjualanGudangAdapter.SearchBarangPenjualanGudangViewHolder(view);    }

    @Override
    public void onBindViewHolder(@NonNull SearchBarangPenjualanGudangViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class SearchBarangPenjualanGudangViewHolder extends RecyclerView.ViewHolder {
        ImageView imgBarang;
        ...
        public SearchBarangPenjualanGudangViewHolder(@NonNull View itemView) {
            super(itemView);
