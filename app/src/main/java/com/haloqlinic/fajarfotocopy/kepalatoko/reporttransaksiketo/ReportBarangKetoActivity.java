...
import com.haloqlinic.fajarfotocopy.databinding.ActivityReportBarangKetoBinding;
...
public class ReportBarangKetoActivity extends AppCompatActivity {
    private ActivityReportBarangKetoBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityReportBarangKetoBinding.inflate(getLayoutInflater());
        View view = binding.getRoot();
        setContentView(view);

        PushDownAnim.setPushDownAnimTo(binding.linearBackReportKeto)
        ...
        binding.spinnerPilihHariBulanReportKeto.setAdapter(adapterPilihan);
        ...
        binding.spinnerPilihHariBulanReportKeto.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                pilihan = binding.spinnerPilihHariBulanReportKeto.getSelectedItem().toString();
        ...
        PushDownAnim.setPushDownAnimTo(binding.btnLihatReportKeto)
                .setScale(MODE_SCALE, 0.89f)
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
    ...
    private void lihatLaporan() {
        ...
        Intent intent = new Intent(ReportBarangKetoActivity.this, WebViewReportMintaBarangKetoActivity.class);
    ...
    private void showDateDialog() {
        ...
        datePickerDialog = new DatePickerDialog(ReportBarangKetoActivity.this, new DatePickerDialog.OnDateSetListener() {
