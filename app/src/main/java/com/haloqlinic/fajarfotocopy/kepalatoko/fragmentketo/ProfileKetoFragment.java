...
public class ProfileKetoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardLogout = rootView.findViewById(R.id.card_logout_keto);
        cardEditProfile = rootView.findViewById(R.id.card_edit_profile_keto);
        cardBantuan = rootView.findViewById(R.id.card_bantuan_keto);
        cardRating = rootView.findViewById(R.id.card_rating_keto);
        ...
        imageView = rootView.findViewById(R.id.img_profile_keto);
