...
public class TambahTokoGudangActivity extends AppCompatActivity {
    ...
    EditText edtId, edtNama, edtProvinsi, edtKota, edtAnggota, edtKelurahan, edtKodePos;
    Button btnSimpan;
    ...
    private void simpanTambahOutlet() {
        ...
        ConfigRetrofit.service.tambahOutlet(id, nama, kota, persentase, jumlah_anggota, alamat).enqueue(new Callback<ResponseTambahOutlet>() {
            @Override
